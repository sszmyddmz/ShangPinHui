    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageList="skuImgList" />
          <!-- 小图列表 -->
          <ImageList :skuImageList="skuImgList" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
...
export default {
  ...
  mounted() {
    //detail挂载完后，派发action获取产品的详情信息
    this.$store.dispatch("getGoodInfo", this.$route.params.skuId);
  },
  computed: {
    ...mapGetters(["categoryView", "skuInfo", "spuSaleAttrList"]),
    skuImgList() {
      //detail父组件，给子组件zoom，传递的数据skuInfo可能是空数组，空数组的第零项可能是undefined
      //undefined.skuImgList报错了，保证父组件给的数据（数组）第零项至少是一个对象
